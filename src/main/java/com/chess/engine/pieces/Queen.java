...
{
	private final static int[] MOVE_OFFSETS_VECTOR_INDEXES = {-9 - 8, -7, -1, 1, 7, 8, 9};

	public Queen(final int pieceIndex, final Color color)
	{
		super(PieceType.QUEEN, pieceIndex, color);
	}
